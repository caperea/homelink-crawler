...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RealEstate.community'
        db.add_column('crawler_realestate', 'community',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['crawler.Community']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RealEstate.community'
        db.delete_column('crawler_realestate', 'community_id')
