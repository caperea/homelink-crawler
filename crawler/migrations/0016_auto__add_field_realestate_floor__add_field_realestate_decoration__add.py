...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RealEstate.floor'
        db.add_column('crawler_realestate', 'floor',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True),
                      keep_default=False)

        # Adding field 'RealEstate.decoration'
        db.add_column('crawler_realestate', 'decoration',
                      self.gf('django.db.models.fields.CharField')(max_length=8, null=True),
                      keep_default=False)

        # Adding field 'RealEstate.nvisitor'
        db.add_column('crawler_realestate', 'nvisitor',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'RealEstate.ncomment'
        db.add_column('crawler_realestate', 'ncomment',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RealEstate.floor'
        db.delete_column('crawler_realestate', 'floor')

        # Deleting field 'RealEstate.decoration'
        db.delete_column('crawler_realestate', 'decoration')

        # Deleting field 'RealEstate.nvisitor'
        db.delete_column('crawler_realestate', 'nvisitor')

        # Deleting field 'RealEstate.ncomment'
        db.delete_column('crawler_realestate', 'ncomment')
    ...
    models = {
        ...
        'crawler.realestate': {
            ...
            'decoration': ('django.db.models.fields.CharField', [], {'max_length': '8', 'null': 'True'}),
            ...
            'floor': ('django.db.models.fields.CharField', [], {'max_length': '16', 'null': 'True'}),
            'hlid': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '64'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'in_sale': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'nbedrm': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'ncomment': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'nlvnrm': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'nvisitor': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
