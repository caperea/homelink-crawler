...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'District', fields ['hlid']
        db.create_unique('crawler_district', ['hlid'])

        # Adding unique constraint on 'Subdistrict', fields ['hlid']
        db.create_unique('crawler_subdistrict', ['hlid'])


    def backwards(self, orm):
        # Removing unique constraint on 'Subdistrict', fields ['hlid']
        db.delete_unique('crawler_subdistrict', ['hlid'])

        # Removing unique constraint on 'District', fields ['hlid']
        db.delete_unique('crawler_district', ['hlid'])
